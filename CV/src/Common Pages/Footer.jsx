...
const Footer = () => {
  return (
    <div className="container-fluid bg-light py-5 px-3">
      <div className="container">
        <div className="row text-center text-md-start justify-content-between">
          ...
          {/* Socials */}
          <div className="col-12 col-md-3 mb-4 mb-md-0">
            <strong className="d-block">Follow Me</strong>
          ...
          <div className="col-12 col-md-3 mb-4 mb-md-0">
            <p className="mb-0">
              <span className="fs-6"><i class="bi bi-c-circle icon "/> 2025 Hetavi Desai</span>
            </p>
          </div>
        </div>
      </div>
